  ...
  <!-- Navigation-->
	<script>
          function check(){
            ...
            if(f.car_passenger.value ==""){
                alert("승차인원을 채워주세요");
                f.car_passenger.focus();
                return;
             }
        	...
        	alert("car_passenger:"+f.car_passenger.value+"car_no:"+f.car_no.value+"car_name:"+f.car_name.value+"car_manufacturer:"+f.car_manufacturer.value+"car_fuel:"+f.car_fuel.value+"car_type:"+f.car_type.value);
            document.f.submit();
         }
            ...
            <table border="0" width="100%"  cellpadding="0" cellspacing="0">
				...
				<tr style="color:#808080;font-size:12pt">			
					...
					<th  width="35%" class="text-left">
						<input name="car_no" type="text" size="30" class="form-control" style="width:250px" value="${modify.car_no}">
					</th>
				</tr>
				<tr style="color:#808080;font-size:12pt">			
					<th  height="60px" width="10%" class="text-center" style="background-color: #fafafa"><a style="color:red">*</a>차종명</th>
					<th  width="35%" class="text-left">
						<input name="car_name"type="text" size="30" class="form-control" style="width:250px" value="${modify.car_name}">
					</th>
					...
					<th  width="35%" class="text-left">
						<select name="car_manufacturer" id="car_manufacturer" class="form-control" style="width:250px">
							<option value="${modify.car_manufacturer}" style="color:black">${modify.car_manufacturer}</option>
				...
				<tr style="color:#808080;font-size:12pt">			
					...
					<th  width="35%" class="text-left">
						<select name="car_fuel" id="car_fuel" class="form-control" style="width:250px">
							<option value="${modify.car_fuel}" style="color:black">${modify.car_fuel}</option>
					...
					<th  width="35%" class="text-left">
						<input name="car_passenger" type="text" size="30" class="form-control" style="width:250px" value="${modify.car_passenger}">
					</th>
				</tr>
				<tr style="color:#808080;font-size:12pt">			
					...
					<th  width="35%" class="text-left">
						<select name="car_type" id="car_type" class="form-control" style="width:250px">
							<option value="${modify.car_type}" style="color:black">${modify.car_type}</option>
					...
					<th  width="35%" class="text-left">
						<!-- <input type="file"> -->
						<input type="hidden" id="car_image" name="car_image" value="${modify.car_image}">
				...
				<tr style="color:#808080;font-size:12pt">			
					...
					<th  width="35%" class="text-left">
					   ...
					   <input type="checkbox" class="custom-control-input" id="customCheck1" <c:if test="${modify.car_trans eq '오토' }">checked</c:if>>
					   <label class="custom-control-label" for="customCheck1">오토메틱</label>
					  </div>
					  <div class="custom-control custom-checkbox">
					   <input type="checkbox" class="custom-control-input" id="customCheck2" <c:if test="${modify.car_trans eq '수동' }">checked</c:if>>
					...
					<th>
					<div id="test">
					<img width="200" weight="200" src="../resources/car/${modify.car_image}"/>
					</div>
					</th>
				</tr>
